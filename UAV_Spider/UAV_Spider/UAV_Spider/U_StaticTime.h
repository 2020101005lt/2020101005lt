/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// U_CStaticTime - CStatic derived numeric counter display
//
...
class U_CMemDC : public CDC {
private:
	CBitmap m_bitmap; // Offscreen bitmap
	CBitmap* m_oldBitmap; // bitmap originally found in U_CMemDC
	CDC* m_pDC; // Saves CDC passed in constructor
	CRect m_rect; // Rectangle of drawing area.
	BOOL m_bMemDC; // TRUE if CDC really is a Memory DC.
public:
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// Function Header
	U_CMemDC(CDC* pDC, CRect rect = CRect(0,0,0,0)) : CDC(), m_oldBitmap(NULL), m_pDC(pDC)
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	{
	...
	U_CMemDC* operator->() {return this;}
	
	// Allow usage as a pointer
	operator U_CMemDC*() {return this;}
};

class U_CStaticTime : public CStatic
{
// Construction
public:
...
// Overrides
	...
	//{{AFX_VIRTUAL(U_CStaticTime)
	//}}AFX_VIRTUAL

// Implementation
public:
	U_CStaticTime();
	virtual ~U_CStaticTime();
...
protected:
	void Update();
	void Draw( U_CMemDC* pDC, DWORD dwChar, int nCol);
